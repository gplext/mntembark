# Consuming MNT Embark Design System in web apps

Read `artifacts/mnt-embark/docs/AGENTS.md` first. This guide covers
...
`artifacts/mnt-embark/docs/migrating-web.md` before writing UI.
...
`node_modules/@workspace/mnt-embark/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/mnt-embark/hooks/use-toast";
```
...
`@workspace/mnt-embark/components/ui/button`. Run the app's typecheck
