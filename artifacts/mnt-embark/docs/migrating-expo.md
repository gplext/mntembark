# Migrating Expo UI to MNT Embark Design System

Read `artifacts/mnt-embark/docs/AGENTS.md` and
`artifacts/mnt-embark/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/mnt-embark/lib/native-theme` and
  `@workspace/mnt-embark/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/mnt-embark/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/mnt-embark` and retains only
