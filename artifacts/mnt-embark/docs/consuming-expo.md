# Consuming MNT Embark Design System in Expo apps

Read `artifacts/mnt-embark/docs/AGENTS.md` first. React Native does
...
`artifacts/mnt-embark/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/mnt-embark/tokens";
...
```tsx
import { nativeTheme } from "@workspace/mnt-embark/lib/native-theme";
import { useColors } from "@workspace/mnt-embark/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/mnt-embark/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/mnt-embark/components/native/badge";
import { Button } from "@workspace/mnt-embark/components/native/button";
import { Card } from "@workspace/mnt-embark/components/native/card";
```
...
Import and render
`@workspace/mnt-embark/components/native/button`, then run Expo
