# Migrating web UI to MNT Embark Design System

Read `artifacts/mnt-embark/docs/AGENTS.md` and
`artifacts/mnt-embark/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/mnt-embark/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/mnt-embark/lib/utils`
- `@/hooks/use-toast` → `@workspace/mnt-embark/hooks/use-toast`
