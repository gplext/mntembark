...
export const DESIGN_SYSTEM = {
  title: 'MNT Embark Design System',
  description:
    'The visual foundation for MNT Embark — an ultra-luxury tour brand for elite travelers. Jet-black surfaces, warm gold accents, and refined serif typography.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'The visual foundations and brand principles of MNT Embark.',
  Page: OverviewPage,
};
    ...
    entries: [
      {
        id: 'color-roles',
        name: 'Color roles',
        description: 'Brand gold, surface blacks, ivory text, and semantic colors.',
        Page: ColorsPage,
      },
    ],
  },
    ...
    entries: [
      {
        id: 'type-scale',
        name: 'Type scale',
        description: 'Cormorant Garamond display type and Montserrat body text.',
        Page: FontsPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Architectural 4 px radius and measured spacing rhythm.',
        Page: LayoutPage,
      },
    ],
  },
    ...
    entries: [
      {
        id: 'button',
        name: 'Buttons',
        description: 'Gold-fill primary, ghost, outline, and destructive variants.',
        Page: ButtonDemo,
      },
      {
        id: 'button-group',
    ...
    entries: [
      {
        id: 'input',
        name: 'Input',
        description: 'Dark field with gold focus ring.',
        Page: InputDemo,
      },
      {
        id: 'input-group',
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        id: 'badge',
        name: 'Badge',
        description: 'Gold-tinted status and category labels.',
        Page: BadgeDemo,
      },
      {
        id: 'card',
        name: 'Card',
        description: 'Dark surface cards with optional gold border treatment.',
        Page: CardDemo,
      },
      {
        id: 'table',
      ...
      },
      {
        id: 'carousel',
        name: 'Carousel',
        description: 'Keyboard-accessible paged content — used for hero images, journals, tours.',
        Page: CarouselDemo,
      },
      {
        id: 'item',
    ...
    entries: [
      {
        id: 'separator',
        name: 'Separator',
        description: 'Horizontal and vertical dividers, optionally gold-tinted.',
        Page: SeparatorDemo,
      },
      {
        id: 'scroll-area',
